...
public class MemDAO {
   ...
   static final String phone_update="update member set mphone=? where mid=?"; // 내정보수정 > 핸드폰번호 수정
   static final String email_update="update member set memail=? where mid=?"; // 내정보수정 > 이메일 수정
   static final String selectOne_mid="select member.*from member join product on member.mid = product.pmid where mid=?"; // 해당 mid의 product의 pmid와 member의 mid가 같은 member
